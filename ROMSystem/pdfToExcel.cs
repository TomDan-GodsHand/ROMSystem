...
namespace ROMSystem
{
    public class pdfToExcel
    {
        ...
        public static async Task<bool> Transform(string filePath, IProgress<int> progress)
        {
            try
            {
                ...
                #region excel操作
progress?.Report(50);
   MaintenanceForm maintenanceForm = new();
               ...
               maintenanceForm.DispatchTime = dateTime;
                ...
                maintenanceForm.Requester = keyValues["报修人"];
                sheet.Range["C4"].Text = "工号/学号";
                sheet.Range["D4"].Text = keyValues["学号/工号"];
                sheet.Range["E4"].Text = "电话";
                sheet.Range["F4"].Text = keyValues["报修人电话"];
                maintenanceForm.PhoneNumber = keyValues["报修人电话"];

                // 第5行
                sheet.SetRowHeight(5, 49);
                sheet.Range["A5:F5"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A5:F5"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                maintenanceForm.RepairPerson = keyValues["维修工人"];

                // 第6行
                sheet.SetRowHeight(6, 49);
                sheet.Range["A6:F6"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A6:F6"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                maintenanceForm.RepairAddress = keyValues["详细地址"];


progress?.Report(75);
                // 第7行
                sheet.SetRowHeight(7, 49);
                sheet.Range["A7:F7"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A7:F7"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                maintenanceForm.RepairContent = keyValues["报修内容"];
                // 第8行
                sheet.SetRowHeight(8, 49);
                sheet.Range["A8:F8"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A8:F8"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                sheet.Range["A9:F9"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A9:F9"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                maintenanceForm.MaterialsUsed = "";
                if (ContainsArabicDigits(text))
                {
                    output = "☑是        □否";
                    maintenanceForm.MaterialsUsed = keyValues["维修材料"];
                }
                else
                    output = "□是        ☑否";
...
progress?.Report(85);
                ...
                sheet.Range["A12:F12"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A12:F12"].BorderInside(LineStyleType.Thin, Color.Black);
                ...
                sheet.Range["A13:F13"].BorderAround(LineStyleType.Thin, Color.Black);
                sheet.Range["A13:F13"].BorderInside(LineStyleType.Thin, Color.Black);
